...
- The GPU-7 catalog has all three free embedding arms, and a least-privilege `synanton-benchmark` principal covers the six benchmark tenants (G3). The harness still needs free-tier throttling and a query-embedding cache (G4).
