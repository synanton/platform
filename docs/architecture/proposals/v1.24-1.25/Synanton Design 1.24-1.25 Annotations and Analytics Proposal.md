...
**Status:** Proposed consolidated design 
  **Version:** 1.25 Consolidated 
  **Document ID:** `synanton-design-1.24-1.25` 
  **Supersedes:** `synanton-design-1.24.md`, `synanton-design-1.25.md` 
...
Design 1.23 explicitly defines the representation decision  and propagation model: a chunk may have one representation, masked and  original representations, or masked-only content where the original is  never stored. citeturn0view0
...
```
docs/architecture/synanton-design-1.24-1.25.md
```

It supersedes:

\- `docs/architecture/synanton-design-1.24.md`
...
Design 1.23 defines the important invariant that a Masked-only original is never persisted downstream. citeturn0view0
...
2. **Synanton Design 1.24/1.25 — this consolidated document** 
