...
**Document ID:** `synanton-design-1.33`\
  ...
  **Version:** 1.33\
  **Date:** 2026-09-06\
  **Extends:** Synanton Design 1.25\
  **Normative security baseline:** Synanton Design 1.23\
  **Related projects:** `synanton/platform`, `synanton/content_extractor`,
  `synanton/gpu-runtime`\
  **Planned operator projects:** `synanton-platform-operator`,
  `content-extractor-operator`, `gpu-runtime-operator`\
...
\> **Kubernetes operators own infrastructure lifecycle; Synanton services
  \> own domain behavior.**

A second rule follows:

\> **One independently operated infrastructure plane should have one
  \> lifecycle authority.**
...
Design 1.25 defines the knowledge, annotation, derived-state,
...
The following projects are proposed:
 ...
 \-------------------------------------------------------------------------------------------------
   ...
   ----------------- ------------------------------ ------------------------------ -----------------
   Core Synanton   `synanton/platform`      `synanton-platform-operator`  Go
   Platform                                    

 Structured    `synanton/content_extractor`  `content-extractor-operator`  Go
   Content                                     
   Extraction                                   
...
Design 1.23 remains authoritative for:
