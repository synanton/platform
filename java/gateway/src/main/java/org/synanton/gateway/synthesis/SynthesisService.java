...
public class SynthesisService {
    ...
    public SynthesisService(GatewayProperties props, LlmClient llmClient, PromptBuilder promptBuilder) {
        this.props = props;
    ...
    public SynthesisResult synthesise(String query, List<Hit> hits, GraphResult graph) {
        ...
        try {
            ...
            log.debug("Synthesis OK: {} tokens in {}ms", response.completionTokens(), latency);
